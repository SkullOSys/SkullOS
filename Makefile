...
KERNEL_SRCS = kernel/kernel.c kernel/util.c kernel/vga.c kernel/vga_manager.c kernel/shell.c kernel/idt.c kernel/pic.c kernel/fs.c kernel/memory.c kernel/timer.c kernel/cpu.c kernel/syscall.c $(LIBC_SRCS)
